...
import RenderDots from '../../src/components/Dots';
...
const defaulStyles = {
  ...
  title: {
    color: '#fff',
    fontSize: 48 * ValueScale(),
    fontFamily: '../../src/assets/font/Roboto-Regular.ttf',
    top: 624 * ValueScale(),
...
export default class Slider extends Component {
  ...
  renderPagination = (index, total, context) => {
    ...
    return (
      <View style={{position:'relative',height: 100,flexDirection: 'row',}}>
        ...
        <View style={{position:'absolute',flexDirection:'row',marginLeft:49*ValueScale(),top:20}}> 
  ...
  render() {
    ...
    // console.log("CCCCC"+ValueScale()+"  "+windowsWidth+"  "+windowsHeight); 
    return (
      <View>
        {androidPages}
        <Swiper
